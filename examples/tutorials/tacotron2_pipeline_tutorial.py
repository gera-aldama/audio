...
print("GENERATING SPECTROGRAM WITH TACOTRON2 WAVERNN")
...
print("STARTING INFERENCE WITH TACOTRON2 WAVERNN")
...
# print("Starting CPU transfer...")
# spec_cpu = spec[0].cpu()
# print("CPU transfer complete")

# print("Starting detach...")
# spec_detached = spec_cpu.detach()
# print("Detach complete")

# print("Starting numpy conversion...")
# spec_numpy = spec_detached.numpy()
# print(f"Numpy array shape: {spec_numpy.shape}")
print("PLOTTING SPECTROGRAM WITH TACOTRON2 WAVERNN")
start_time = time.time()
# _ = plt.imshow(spec[0].cpu().detach().numpy(), origin="lower", aspect="auto")
...
#
print("GENERATING WAVEFORM WITH TACOTRON2 WAVERNN VOCODER")
start_time = time.time()
bundle = torchaudio.pipelines.TACOTRON2_WAVERNN_CHAR_LJSPEECH
...
text = "Hello world! Text to speech!"
print("STARTING INFERENCE WITH TACOTRON2 WAVERNN VOCODER")
start_time = time.time()
with torch.inference_mode():
    processed, lengths = processor(text)
    processed = processed.to(device)
...
print("PLOTTING WAVEFORM WITH TACOTRON2 WAVERNN VOCODER")
start_time = time.time()
